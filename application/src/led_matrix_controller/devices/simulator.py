...
class TerminalDevice(BaseDevice):
    ...
    def send(self, data: bytes, wait_ack: bool = True) -> bool:
        ...
        try:
            ...
            rgb565 = np.frombuffer(raw_data, dtype="<u2").reshape(DISPLAY_HEIGHT, DISPLAY_WIDTH)
...
class ImageDevice(BaseDevice):
    ...
    def __init__(self, output_dir: str = "output", scale: int = 10, led_style: bool = True):
        """
